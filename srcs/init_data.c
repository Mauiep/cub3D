...
/*
	...
	ensuite check si eline_lengthes sont presente
*/
...
void	init_textures(t_data *data)
{
	...
	data->tex.no.addr = (unsigned int *)mlx_get_data_addr(data->tex.no.img,
			&data->tex.no.bits_per_pixel, &data->tex.no.ll, &data->tex.no.end);
	data->tex.so.addr = (unsigned int *)mlx_get_data_addr(data->tex.so.img,
			&data->tex.so.bits_per_pixel, &data->tex.so.ll, &data->tex.so.end);
	data->tex.we.addr = (unsigned int *)mlx_get_data_addr(data->tex.we.img,
			&data->tex.we.bits_per_pixel, &data->tex.we.ll, &data->tex.we.end);
	data->tex.ea.addr = (unsigned int *)mlx_get_data_addr(data->tex.ea.img,
			&data->tex.ea.bits_per_pixel, &data->tex.ea.ll, &data->tex.ea.end);
